...
/**
 * Элемент вывода даты и времение с радиокнопкой, может использоваться в разных компонетах
 * Имеет два состояния (активный / не активны) в зависимости от состояния меняется background и состояние радиокнопки
 * @param props {active} -  состояние элемента, {data} -данные для отображения (day- день, data- число, time- время)
 */
